        ...
        <Card className="w-full h-full md:w-[487px] border-none shadow-none p-4">
            ...
            <CardContent className="p-7 flex flex-col gap-4">
                <Button 
                    variant="secondary" 
                    size="lg" 
                    className="w-full rounded-lg font-semibold py-2 bg-white text-black"
                    disabled={isLoading}
                >
                ...
                <Button 
                    variant="tertiary" 
                    size="lg" 
                    className="w-full rounded-lg text-black font-semibold py-2 bg-white"
                    disabled={isLoading}
                >
            ...
            <CardContent className="p-7 flex items-center justify-center">
                <p className="text-sm">
                    ...
                    <Link href={"/sign-up"}>
                        <span className=" text-[#D69D78]">Sign Up</span>
                    </Link>
                </p>
            </CardContent>
        </Card>
